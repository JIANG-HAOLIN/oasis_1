...
def add_all_arguments(parser, train):
    #--- general options ---
    parser.add_argument('--name', type=str, default='oasis_cityscapes', help='name of the experiment. It decides where to store samples and models')
    ...
    parser.add_argument('--dataroot', type=str, default='/data/public/cityscapes', help='path to dataset root')
    parser.add_argument('--dataset_mode', type=str, default='cityscapes', help='this option indicates which dataset should be loaded')
